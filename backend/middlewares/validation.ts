...
export const validatePathMiddleware = (type: any, skipMissingProperties = false) => {
...
export const validateBodyMiddleware = (type: any, options = DEFAULT_VALIDATION_CONFIGURATION) => {
  return (req, res, next): any => {
...
export const validateParamMiddleware = (type: any, skipMissingProperties = false) => {
  return (req, res, next): any => {
...
export const validateQueryMiddleware = (type: any, skipMissingProperties = false) => {
  return (req, res, next): any => {
